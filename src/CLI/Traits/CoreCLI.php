...
trait CoreCLI
{
    ...
    {\SwellDevelopment\SwellCore\CLI\CustomMethods::PreRun();
        $ns = $this->app_namespace;var_dump($ns . '\CustomMethods::PreRun');
    ...
    //*************************************************************************
    //*************************************************************************
    protected static function PrintInformation($msg, $depth=0, $fg_color='blue', $bg_color=null)
    {
